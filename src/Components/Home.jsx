...
function FunctionalComponent() {
  return (
    <>
      ...
      <br></br><br></br><br></br>
      <h1 style={{ fontsize: 180, padding: 30, color: '#000',textAlign:"center"}}><b>OUR FOCUS IS OUR CLIENTS SUCCESS</b></h1>
       
      <Card style={{ width: '18rem', float: 'left', margin: 30, border: 'none' ,marginLeft:150}}>
        <div className="img">
      ...
      <div className="advice" >
        <br></br><br></br>
        <h1 style={{ fontsize: 180,textAlign:"center", color: '#3e4952' }}><b>ADVICE ON HOW TO MAKE WISE INVESTMENTS</b></h1>
        <p style={{ fontSize: 22,paddibng:30,textAlign:"justify", color: '#3e4952' }}>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
        &nbsp;&nbsp;Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip</p>
        
        <Card style={{ width: '23rem', float: 'left', margin: 30,marginLeft:40, border: 'none' }}>
        ...
        <Card style={{ width: '23rem', float: 'left', margin: 20, border: 'none' }}>
      ...
      <div>
        <section class="">
          <div class="container-fulid">
            <div class="col-md-6 col-sm-6 col-xs-12" style={{ float: 'left', height: 430, background: 'rgb(253, 106, 52)',textAlign:"start", color: 'white' }}>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12 pd-zero" style={{ float: 'left', height: 430, background: '#3e4952',textAlign:"inherit", color: 'white' }}>
      ...
      <Card style={{ width: '18rem', float: 'left', margin: 30,marginLeft:6, border: 'none' }}>
        <div className="img">
      ...
      <Card style={{ width: '18rem', float: 'left', margin: 30, marginLeft: 50, border: 'none' }}>
        <div className="img">
      ...
      <div style={{ height: 400, backgroundColor: 'grey', marginTop: 100 }}>
        <br></br><br></br><br></br>
        <h5 ><b>HABER<span style={{}}> © 2022 Privacy policy</span></b></h5>

        <ul style={{ listStyle: 'none', }}>
          <li ><a style={{ marginTop: 10, marginLeft: 150, fontSize: 40, color: 'orange', float: 'left' }} href="#" class="fa fa-twitter-square" id="twit"></a></li>
          <li><a style={{ marginTop: 10, marginLeft: 20, fontSize: 40, color: 'orange', float: 'left' }} href="#" class="fa fa-youtube"></a></li>
          <li><a style={{ marginTop: 10, marginLeft: 20, fontSize: 40, color: 'orange', float: 'left' }} href="#" class="fa fa-rss"></a></li>
          <li><a style={{ marginTop: 10, marginLeft: 20, fontSize: 40, color: 'orange', float: 'left' }} href="#" class="fa fa-facebook-square"></a></li>
          <li><a style={{ marginTop: 10, marginLeft: 20, fontSize: 40, color: 'orange', float: 'left' }} href="#" class="fa fa-google-plus-square"></a>
          </li>
        </ul>
        <div className="google-map-code" style={{ marginLeft: 340 }}>
